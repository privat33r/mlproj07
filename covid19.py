...
x_train,x_test,y_train,y_test=buildData(filename)
...
#Stops and saves when testloss doesn't improve in 1000 epochs (instead of 10)
  if testloss.item() < min_testloss:
    ...
    if early_stopcount >= 1000:
      ...
      print("Minimum Test Loss:",min_testloss)
      early_stopped = True
      break
...
# Do data augmentation by adding Gaussian noise to the training set. This might make the model perform better on the validation/test set.
